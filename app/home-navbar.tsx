...
export default function HomeNavbar({
  ...
  setShowAuthPopup: (value: boolean) => void;
}) {
  ...
  const learnMoreContent = (
    <p className="text-lg md:text-xl text-gray-500 mb-6">
      S.E.S built Funding.Live as a side project to improve the efficiency of
      sourcing and tracking deals for investors.
      <br />
      <br />
      Reach out to me on{' '}
      <a
        href="https://www.linkedin.com/in/samielsolh/"
        target="_blank"
